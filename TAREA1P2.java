...
public class TAREA1P2 extends JFrame
        implements ActionListener //PaolaNeri ClaseGraficacion 2020
{
    ...
    public static void main(String[] args) throws IOException {
        ...
        TAREA1P2 i = new TAREA1P2();//se llama al constructor del frame
    }

    public TAREA1P2() throws IOException//crear el constructor del frame
    {
        ...
        menu1.add(it4);// agrega items al menu 1 y 
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (object == it1) {
            dibuja1(lienzo1.getGraphics());
        }
        if (object == it2) {
            dibuja2(lienzo1.getGraphics());
        }
        if (object == it3) {
            dibuja3(lienzo1.getGraphics());
        }
        if (object == it4) {
            dibuja4(lienzo1.getGraphics());
        }
        if (object == it5) {
            dibuja5(lienzo1.getGraphics());
        }
    }
